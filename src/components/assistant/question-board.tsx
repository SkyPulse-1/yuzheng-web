  ...
  return (
    <div className="question-board">
      <div className="question-board-header">
        ...
        <form onSubmit={submit} className="flex w-full max-w-sm gap-2"><input aria-label="搜索问题卡片" value={query} onChange={(event) => setQuery(event.target.value)} className="form-field" placeholder="搜索分析需求" /><button className="secondary-button">搜索</button></form>
      </div>
