  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#f7f4ed] text-stone-900">
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-5 py-6 sm:px-8">
        ...
        <Link href="/login" className="rounded-xl border border-stone-300 bg-white/60 px-5 py-2.5 text-sm font-medium transition hover:border-stone-500 hover:bg-white">登录</Link>
      </nav>
      <section className="mx-auto grid min-h-[calc(100vh-88px)] max-w-7xl items-center gap-16 px-5 pb-16 pt-10 sm:px-8 lg:grid-cols-[1.1fr_0.9fr] lg:py-16">
        <div>
          ...
          <div className="mt-10 flex flex-col gap-3 sm:flex-row">
            <Link href="/login" className="inline-flex h-12 items-center justify-center rounded-xl bg-stone-900 px-7 text-sm font-semibold text-white transition hover:bg-stone-700">进入我的知识空间</Link>
